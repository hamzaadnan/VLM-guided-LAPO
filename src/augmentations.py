"""
This file is the source of the Augmenter class.
Augmenter randomly applies one of the following transformations to each image in a batch:
1. Do Nothing
2. Shift
3. Rotate
4. Perspective
5. Shift+Rotate
6. Rotate+Shift
7. Rotate+Perspective
8. Perspective+Rotate
"""
